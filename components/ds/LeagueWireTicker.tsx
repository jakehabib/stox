...
export function LeagueWireTicker({ items }: { items: TickerItem[] }) {
  ...
  return (
    <div className="border-b border-line bg-surface/60 overflow-hidden flex items-center text-xs">
      ...
      <div className="relative z-10 label-sm shrink-0 px-3 py-1 border-r-2 border-accent2/40 bg-raised text-accent2">League Wire</div>
      ...
      <div className="ticker-track flex items-center whitespace-nowrap py-1 -ml-8 pl-8">
        {loop.map((item, i) => (
