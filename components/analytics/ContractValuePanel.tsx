  ...
  return (
    ...
    >
      {!capEnabled ? (
        ...
        <>
          <div className="grid grid-cols-[34px_minmax(150px,1fr)_minmax(110px,1.1fr)_70px_66px] gap-2.5 label-sm text-[9.5px] pb-1.5 border-b border-line">
            <span />
            <span>Player</span>
          ...
          {rows.map((r) => {
            ...
            return (
              <Link
                ...
                className="grid grid-cols-[34px_minmax(150px,1fr)_minmax(110px,1.1fr)_70px_66px] gap-2.5 items-center py-1 border-b border-line/45 hover:bg-raised/45"
